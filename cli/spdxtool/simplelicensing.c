...
spdxtool_simplelicensing_licenseExpression_new(pkgconf_client_t *client, const char *license)
{
	...
	nlicense = NULL;
	if (!(expression->spdx_id = spdxtool_util_get_spdx_id_string(client, expression->type, license)))
		goto oom;
 ...
 * !doc
 *
 * .. c:function:: spdxtool_serialize_value_t * spdxtool_simplelicensing_licenseExpression_to_object(pkgconf_client_t *client, const char *creation_info, const spdxtool_simplelicensing_license_expression_t *expression)
 *
